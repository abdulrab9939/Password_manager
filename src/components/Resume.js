...
const Resume = () => {
  ...
  <div class="base">
    ...
    <img src="" /> 
      ...
      <div class="info">
        <h1 class="name">Abdul Rab</h1>
        <h2 class="job">MERN Web Developer</h2>
      </div>
    </div>
    <div class="about">
    ...
    <div class="contact">
      <h3>Contact Me</h3>
      <div class="call"><a href="tel:9939812137"><i class="fas fa-phone"></i><span>9939812137</span></a></div>
      <div class="address"><a href="https://goo.gl/maps/fiTBGT6Vnhy"><i class="fas fa-map-marker"></i><span>India ,Bihar</span></a>
      </div>
      <div class="email"><a href="mailto:abdulrab@gmail.com"><i class="fas fa-envelope"></i><span>abdulrab4546@gmail.com</span></a></div>
      <div class="website"><a href="http://astronaomical.com/" target="_blank"> <i class="fas fa-home"></i><span>abcd.com</span></a></div>
    </div>
    <div class="follow">
      <h3>Follow Me</h3>
      <div class="box">
  ...
  <div class="func">
    <div class="work">
      ...
      <ul>
        <li><span>Technical Consultant -<br></br> Web Design</span><small>Delhi</small><small>Apr 2020 - Now</small></li>
        <li><span>Web Designer</span><small>Banglore</small><small>Jan 2018 - Apr 2018</small></li>
        <li><span>Intern - Web Design</span><small>Banglore</small><small>Aug 2017 - Dec 2017</small></li>
      </ul>
    </div>
    <div class="edu">
      <h3><i class="fa fa-graduation-cap"></i>Education</h3>
      <ul>
        <li><span>Bachelor of Science <br></br>Web Design and Development</span><small>BYU-Idaho</small><small>Jan. 2016 - Apr. 2018</small></li>
        <li><span>Computer Science</span><small>MANUU</small><small>Sept. 2020 - Dec. 2023</small></li>
        <li><span>High School</span><small>TRMP High School</small><small>Jan. 2018 - Jun. 2020</small></li>
      </ul>
    </div>
    <div class="skills-prog">
      ...
      <ul>
        ...
        <li data-percent="50"><span>React js</span>
          <div class="skills-bar">
            <div class="bar"></div>
          </div>
        </li>
        <li data-percent="40"><span>Django</span>
          <div class="skills-bar">
            <div class="bar"></div>
          </div>
        </li>
        <li data-percent="55"><span>MongoDB</span>
          <div class="skills-bar">
            <div class="bar"></div>
          </div>
        </li>
      ...
      <ul>
        ...
        <li data-percent="85">
          <svg viewbox="0 0 100 100">
            <circle cx="50" cy="50" r="45"></circle>
            <circle class="cbar" cx="50" cy="50" r="45"></circle>
          </svg><span>Graphic Design</span><small></small>
        </li>
        <li data-percent="65">
          <svg viewbox="0 0 100 100">
            <circle cx="50" cy="50" r="45"></circle>
